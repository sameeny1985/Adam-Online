...
# زمان‌بندی جمع‌آوری هر ۱۵ دقیقه (برای Render رایگان ممکن است نیاز به cron جدا باشد)
scheduler = BackgroundScheduler(daemon=True)
scheduler.add_job(func=run_fetch_cycle, trigger="interval", minutes=15, id="fetch_news")
scheduler.start()
...
<body>
    <header>
        ...
        <p class="subtitle">جمع‌آوری از بیش از ۳۰ منبع معتبر جهان • ترجمه خودکار به فارسی • به‌روزرسانی هر ۱۵ دقیقه</p>
