...
{% if news %}
  ...
  <div class="card">
    ...
    {% if item.description_fa and 'Error 500' not in item.description_fa and 'Server Error' not in item.description_fa and 'Please try again' not in item.description_fa %}<p style='color:#94a3b8;margin:0.4rem 0'>{{ item.description_fa[:400] }}</p>{% endif %}
