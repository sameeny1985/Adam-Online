...
### ویژگی‌ها
- **اولین اجرا**: همه اخبار ۱۲ ساعت اخیر از تمام منابع را می‌آورد و در سایت + تلگرام قرار می‌دهد
- **از آن به بعد**: هر **۱ دقیقه** یک‌بار چک می‌کند → هر خبر جدید بلافاصله در **بالای سایت** و **پایین کانال تلگرام** ظاهر می‌شود
- فیلتر فقط اخبار مرتبط با ایران
- ترجمه خودکار عنوان و خلاصه به فارسی با کیفیت بالا
...
- از سرویس رایگان مثل [cron-job.org](https://cron-job.org) هر **۱ دقیقه** به endpoint زیر درخواست POST بزنید (تا خواب نرود):
  ```
